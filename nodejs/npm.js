...
4.package.json main指定index.js  一般默认index.js  在别人引入模块的时候默认搜索包名字下的index.js文件 
如果代码都写在了别的文件里 别人用的时候 require（包名/模块名）
5.npm publish  把包推送上去  如果package.json 中包名字是wlh-p 那么npm服务器会生成wlh-p文件夹 npm已经解决了包的依赖问题  
